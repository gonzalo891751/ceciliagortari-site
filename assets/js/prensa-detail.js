        ...
        if (igId) {
            instagramBlock = `
                ...
                <div class="text-center mb-8">
                    <a href="${item.instagram_url}" target="_blank" class="text-sm text-brand-blue hover:underline">Ver en Instagram</a>
                </div>
            `;
        } else {
            instagramBlock = `
                <div class="my-8 text-center">
                    <a href="${item.instagram_url}" target="_blank" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full font-bold hover:opacity-90 transition">
