...
| Proyectos activos al cerrar la actualización | 174 |
| Proyectos activos en la comprobación final | 175 |
...
Los 175 proyectos activos de la comprobación final no contradicen los 143 del informe: los 143 son los presentados conciliados y publicados. Al cerrar la carga había 174 activos. Después apareció concurrentemente `P-20193`, un borrador no publicado y ajeno a la nómina; se preservó sin modificar. De los registros preexistentes, 30 permanecieron sin cambios y `P-0067` quedó fuera de publicación para revisión.
...
- 174 proyectos, antes de la aparición concurrente de `P-20193`;
- 203 documentos listados y descargados;
- 39.052.828 bytes;
- 0 archivos vacíos;
- 0 descargas fallidas.

La comprobación concurrente se protegió con un tercer respaldo de cierre:

`C:\Users\gonza\Documents\Codex\2026-07-28\files-mentioned-by-the-user-proyectos\work\backups\proyectos-cierre-20260729-001722`

Este último contiene 175 proyectos y los mismos 203 documentos, con 0 archivos vacíos y 0 descargas fallidas.
...
- 1 registro no conciliado (`P-0067`) quedó preservado como `En trabajo`, sin fecha ni trámite.
...
El único caso para decisión humana es `P-0067`, “Declaración de interés: Actividad por el día de la tierra”. No figura en los dos informes y no se obtuvo una ficha oficial inequívoca. No se borró: se conservó con su DOCX, quedó `En trabajo` y sin fecha ni estado de trámite para que no aparezca como presentado.

Durante la comprobación posterior al commit apareció `P-20193`, título “(Borrador)”, estado `Pendiente`. Fue una modificación concurrente posterior al respaldo final y no pertenece a los 143 expedientes; no se alteró ni se publicó.
