...
const DEFAULT_TITLE = "Detalle de Novedad | Cecilia Gortari";
...
export const onRequest: PagesFunction<Env> = async (ctx) => {
  ...
  const canonicalUrl = id
    ? `${CANONICAL_DOMAIN}/novedades/detalle/?id=${encodeURIComponent(id)}`
    : `${CANONICAL_DOMAIN}/novedades/detalle/`;
...
<body>
  <main class="press-detail flex-grow">
    ...
    <div class="container mx-auto px-4 relative z-10">
      <a href="/novedades/" class="press-detail__back">
      ...
      <section id="latest-news-container" class="latest-news-section hidden">
        <h3 class="latest-news__title">Últimas novedades</h3>
  ...
  <script src="/assets/js/prensa-feed.js?v=202603141200"></script>
  <script src="/assets/js/prensa-detail.js?v=202603141200"></script>
  <script src="/assets/js/site.js?v=202603141200"></script>
</body>
</html>`;
